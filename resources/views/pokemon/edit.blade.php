            ...
            <form action="{{ route('pokemon.update', $pokemon) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        aria-label="Default select example" name="primary_type" id="primary_type" value="{{ old('primary_type', $pokemon->primary_type)}}">
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input @error('is_legendary') is-invalid @enderror" type="checkbox" name="is_legendary" value="1" id="is_legendary" {{ old('is_legendary', $pokemon->is_legendary) ? 'checked' : '' }}>
                      ...
                      <div class="col-6">
                        ...
                        <img src="{{ Storage::url($pokemon->photo)}}" class="img-thumbnail w-25">
                    </div>
